...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSPURP_ICONSIZE,STATUSPURP_ICONSIZE));
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(secs < 90*60 && count >= nTotalBlocks)
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(":/icons/synced").pixmap(STATUSPURP_ICONSIZE, STATUSPURP_ICONSIZE));
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_active").pixmap(STATUSPURP_ICONSIZE,STATUSPURP_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Mining purplecoin at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSPURP_ICONSIZE,STATUSPURP_ICONSIZE));
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_open").pixmap(STATUSPURP_ICONSIZE,STATUSPURP_ICONSIZE));
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_closed").pixmap(STATUSPURP_ICONSIZE,STATUSPURP_ICONSIZE));
